...
Bu, yazılım geliştirme için 68 özel agent, 289 skill, 98 command ve otomatik hook iş akışları sağlayan **üretime hazır bir AI kodlama eklentisidir**.
