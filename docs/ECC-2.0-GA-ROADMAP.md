...
- The new #2015 setup-location Q&A was answered and marked accepted. The
  ...
  normal workspace, install the `communityhelp@communityhelp` Claude plugin once, copy only needed
...
- A detached clean worktree at
  ...
  install, enabled plugin listing, and clean uninstall for `communityhelp@communityhelp`
  `2.0.0-rc.1`.
