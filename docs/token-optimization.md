...
- `ECC_DISABLED_MCPS` only affects ECC-generated MCP config output during install/sync flows, such as `install.sh`, `node scripts/ecc.js install`, and Codex MCP merging. It is not a live Claude Code toggle.
